...
SENSOR_PROFILES = {
    ...
    'legion': {
        ...
        'fields': {
                ...
                'catid':         {'tag': 'PRODUCTORDERID',                         # ← changed
                                  'fallback_tags': ['PRODUCTCATALOGID', 'CATID']}, # CATID as last resort
    ...
    'pixxel_fpt': {
        ...
        'metadata_format': 'json',
        'fields': {
            # Pixxel FPT geojsons typically have these in `properties`:
            'sensor_id_raw':    'properties.satellite_id',
            'catid':             'properties.order_id',
            'acquired':          'properties.acquired',
            'cloud_percent':     'properties.cloud_percent',
    ...
    'airbus_dimap': {
        ...
        'fields': {
            ...
            'catid':         {'tag': 'DATASET_NAME', 'fallback_tags': ['JOB_ID']},
